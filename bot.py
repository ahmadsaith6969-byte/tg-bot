...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
  ...
  if query.data == "btn_profile":
    ...
    msg = (
        ...
        f"{stk_summary}\n"
        f"💡 **Stock Add karne ka tareeqa:**\n"
        f"Chat mein command likhein:\n"
        f"`/addstock gemini [link]`\n"
        f"`/addstock nordvpn [account]`\n"
        f"`/addstock canva [link]`\n"
        f"`/addstock duolingo [account]`"
    )
...
def main():
  ...
  print("Complete Multi-Product Store Bot is Running...")
  app.run_polling()
